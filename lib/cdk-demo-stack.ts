...
export class CdkDemoStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
     ...
     * This is a demo project so have ben removed for costs saving
     */
    ...
    /**
     * The following is the working configuration needed to provision
     * an Aurora serverless v2 RDS instance and accompanying resources
     * However Aurora Serverless does not scale to zero and is costly
     * for a demo project. So this project uses Neon DB instead
     *
     */
